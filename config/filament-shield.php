...
return [
    ...
    */
    ...
    'super_admin' => [
        /*
         * Superadmin role - maps to the "Superadmin (everything)" role.
         * This role will automatically receive all permissions generated by Shield.
         */
        'enabled' => true,
        'name' => 'Superadmin',
    ...
    */
    ...
    'panel_user' => [
        /*
         * We manage panel access explicitly via roles:
         * - Class Representative
         * - Admin
         * - Superadmin
         *
         * So we disable the generic panel_user role to avoid confusion.
         */
        'enabled' => false,
        'name' => 'panel_user',
    ],
