...
<head>
    ...
    <title>Schedule Request Submitted - PUP</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Your schedule request has been submitted successfully. Here are the details:</p>

        <table class="details-table">
            <tr>
                <td class="info-label">Room</td>
                <td class="info-value">{{ $schedule->room?->room_number ?? 'To be assigned' }}</td>
            </tr>
            <tr>
        ...
        <div class="note">
            <strong>📌 Next Steps:</strong> Your request is pending approval. You will receive another email notification once your request has been approved or rejected by an administrator.
        </div>
