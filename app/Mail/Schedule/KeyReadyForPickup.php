...
class KeyReadyForPickup extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Key Ready for Pickup - {$roomInfo} - {$dateInfo}",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.schedule.key-ready-for-pickup',
        );
    }
